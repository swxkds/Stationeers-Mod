...
namespace meanran_xuexi_mods_xiaoyouhua
{
    public static partial class 扩展方法
    {
        ...
        private static void 设置链接物体(LogicBatchReader 批量读取器, ILogicable 选择焦点)
        {
            ...
            //批量读取器.CurrentPrefab = 选择焦点 as Device;
            批量读取器.CurrentPrefabHash = 选择焦点.GetPrefabHash();
    ...
    public class LogicBatchReader_InteractWith_PrefixPatch
    {
        // 添加了光线命中的事件处理逻辑
        [HarmonyPrefix]
        public static bool 交互事件处理(LogicBatchReader __instance, ref Thing.DelayedActionInstance __result, Interactable interactable, Interaction interaction, bool doAction = true)
        {
